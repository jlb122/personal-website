...
<div id="layout">
 ...
 <div id="msform">
	...
	<!-- fieldsets -->
		<fieldset>
		<h2 class="fs-title">Adding Similar Frame</h2>
<?php 
$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
...
echo '<form class="update" id="form" method="POST" action="adding.php" enctype="multipart/form-data">';
...
echo "</table>";
echo "<br><input type='submit' value='Add Frame' OnClick=\"return confirm('Are You Sure You Want To Add This Frame');\">";
echo '</form>';
