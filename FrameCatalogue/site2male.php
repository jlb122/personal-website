...
<title>Male Recommendation Results</title>
</head>
 <body>
<div id="layout">
    <!-- Menu toggle -->
...
$query = "SELECT * FROM $dbname.glasses WHERE (`gender`='male' OR `gender`='unisex')";
...
{ 
   echo "<br><br>Nothing was found that matched your search - Please Try Again By Clicking The Start Again Button Below<br><br>"; 
	...
	mysqli_close($db);
	?>
			<br><a href="male.php"><input type="submit" name="previous" class="previous action-button" value="Start Again"/></a>
