...
<title>Female Frame Recommender</title>
</head>
<style>
...
<form id="msform" action="site2female.php" method="get">
	<!-- progressbar -->
	<ul id="progressbar">
	...
	<fieldset>
		...
		<input type="checkbox" name="type[]" id="cateye" value="cateye" onchange="document.getElementById('next').disabled = !this.checked;"/>
		<label for="cateye" class="action-buttonshape" title=" Cat-eye eyewear is characterized by rounded frames that flare out near the temples. Cat-eye frames became popular in the 1950s and 1960s but still have a loyal following amongst women with a retro style. Cat-eye-shaped frames tend to be more playful and are ideal for women with square or diamond faces.">
		<img src="pictures/williammorris9912.png" style="max-width:2.5em; max-height:1.5em;"/>
		<p style="font-size:28px; margin-top:.5em;">Cateye</p>
		</label>
		...
		<input type="checkbox" name="colour[]" id="pink" value="pink" onchange="document.getElementById('next1').disabled = !this.checked;"/>
		<label for="pink" class="action-buttonshape">
		<img src="colour/pink.jpg" style="max-width:1em; max-height:1em;"/>
		<p style="font-size:28px; margin-top:.5em;">Pink</p></label>
