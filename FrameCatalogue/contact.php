...
<div id="layout">
 ...
 <div id="msform">
	...
	<!-- fieldsets -->
		<fieldset>
		<h2 class="fs-title">Eyetest Appointment Request</h2>
<br>
    <form class="form" method="post" id="form" action="mail.php">
      ...
      <br>
	  <p class="p">Desired Appointment Date: *</p><br><h4 style="color:#ed145a"><input type="text" name="date" id="datepicker"></h4>
<br>
	<p class="p">Desired Appointment Time/s: *</p><h4 style="color:#ed145a; border:none"><input type="checkbox" name="time[]" required></h4><br><br>
	<input type="checkbox" name="time[]" id="9" value="9-11am"><label for = "9"> 9-11am</label>
	<input type="checkbox" name="time[]" id="11" value="11am-1pm"><label for="11">11am-1pm</label>  
	<input type="checkbox" name="time[]" id="1" value="1-3pm"><label for ="1">1-3pm</label>
	<input type="checkbox" name="time[]" id="3" value="3-5pm"><label for ="3">3-5pm</label><br><br>  
...
$(function() {
	$("#datepicker").datepicker({ dateFormat: 'dd/mm/y', minDate: 0 });
 });
