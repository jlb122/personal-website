...
<a href="addsimilar.php"><input type="button" class="clear" value="Clear All Filters"></a>
<div id="filter"><br>
...
echo "<tr>";
    echo '<div class="product-content"><td align="center" style="margin;">'."<a href=frame.php?product=".$row['id'].">". $row ['glasses'].'</a>'."</td></div>";
	echo "</tr>";
	echo "<tr>";
	...
	echo "<tr>";
    echo '<div class="product-content"><td align="center">'."<a href=\"addingsimilar.php?id=".$row['id'].'&return_url='.$current_url."\"><input type='button' value='Add Similar' style='background-color:#ed145a;color:white;cursor:pointer'></a>"."</td></div>";
	echo "</tr>";
	echo "</tbody>";
    echo '</div>';
...
$("input[type='checkbox']").change(function() {
   $(this).closest("label").toggleClass("tbody1"); 
});
