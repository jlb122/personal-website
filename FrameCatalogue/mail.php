...
$formcontent ="<b>Eyetest Appointment Request</b><br><br> From: $name <br> Email: $email<br> Contact Number: $number<br> Desired Appointment Date: $date<br> Desired Appointment Time/s: ";
if(empty($_POST['time'])){
$formcontent .=  "No Times Were Selected";
} 
else { 
$formcontent .= implode(", ",$_POST['time']);
}
$formcontent .="<br> Visited 4Eyes In Last Year: $first<br> Student?: $student<br>";	
if ($wishlist == 'Yes'){
...
foreach ($_SESSION["products"] as $cart_itm)
	...
	$formcontent .="No Glasses in Wishlist<br>";
	}
...
$subject = "Eyetest Apointment Request";
